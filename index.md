...
а) Легкое игривое приглашение: «Погнали на выставку вина и сыра в четверг» (хорошо канает, если тян явно заинтересована)
б) Приглашение с демонстрацией что вы такой дохуя занятой и активный персонаж: «Я в четверг иду на выставку маринованных хуёв, айда со мной».
...
А вот тут хуюшки, тни ответственность на себя за секс брать не любят. Тебе придется самому в какой-то момент проявлять инициативу, кек, принять решение и начать активные действия.
...
а. **Нарциссизм** (эгоцентризм сигнализирует о том, что другим труднее ебать мозги тебе)
б. **Тенденция к манипуляции другими людьми** (Макиавеллизм)
в. **Психопатия** (импульсивность, пренебрежение социальными нормами, безжалостность)
...
Косяки, после которых тян проваливается по уровню, как правило вызваны постепенной утратой влечения к вам, снижением сознательного усилия и переходом в режим "поиск потенциального Ерохина".
**Примеры таких косяков:**
...
О: 1) Удалить ее отовсюду и избегать контактов ирл. Выбросить все напоминающее о ней.
...
О: 1) Подтянутая тушка, выжать максимум из внешности
...
О: 1) Навязчиво отираться возле тни, демонстрируя свои влажные мечты. Заебывать пространными звонками.
...
О: Есть некоторые качества даже у успешных якобы кунов, которые не позволяют им трахать тней. Это: 1) не-легкость в общении, загрузность, задротство 2) хуевая, отпугивающая тней одежда 3) личностные недостатки типа жадности, мелочности, истеричности (привет, мамино воспитание) 4) некрутая "странность". Алсо, вижу очень много истериков среди молодых кунов, хуй знает почему, кек.
...
О: 1. Если у тян нет представлений о своём будущем, о возможной карьере, работе - сразу дропать на хуй.
